...
var FAKE_USER_DATA = {
  cat: {
    ...
    profilePictureUrl: 'images/react_lifecycle_cat_profile_picture.jpg',
    friends: ['komodo']
  },
  dog: {
    name: 'Doggy Dog',
    bio: "I'm the doggity dog! Woof woof!",
    profilePictureUrl: 'images/react_lifecycle_dog_profile_picture.jpg',
    friends: ['komodo']
  },
  komodo: {
    name: 'Lizard Lady',
    bio: "I'm a Komodo dragon. You'll love me.",
    profilePictureUrl: 'images/react_lifecycle_komodo_profile_picture.jpg',
    friends: ['cat', 'dog']
  }
};
